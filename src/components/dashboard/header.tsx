...
export function DashboardHeader() {
  ...
  const getNotificationBg = (type: string, read: boolean) => {
    ...
    switch (type) {
      ...
      case 'update': return cn(base, 'border /20');
        ...
        <div className={cn(
          ...
          <Button
            ...
            className={cn(
              ...
              searchFocused ? "rounded-b-none border /30 bg-background" : "bg-muted/10",
          ...
          <AnimatePresence>
            {searchFocused && (
              <motion.div
                ...
                className="absolute left-0 right-0 mt-0 bg-background border border-t-0 border /20 rounded-b-lg shadow-xl overflow-hidden z-20"
                initial="hidden"
                animate="visible"
                exit="hidden"
                  ...
                  <DropdownMenuTrigger asChild>
                    <Button
                      ...
                      className={cn(
                        ...
                        quickActionsOpen && "bg-primary/10 border /30"
                      )}
                    >
                ...
                {quickActions.map((action, i) => (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div className="rounded-md h-8 w-8 bg-primary/5 flex items-center justify-center flex-shrink-0 border border /10">
                        {action.icon}
                      </div>
                      <div>
                  ...
                  <DropdownMenuTrigger asChild>
                    <Button
                      ...
                      className={cn(
                        ...
                        notificationsOpen && "bg-primary/10 border /30"
                      )}
                    >
              ...
              <DropdownMenuContent align="end" className="w-96 p-0 backdrop-blur-md">
                <div className="p-4 border-b border-border/80">
                  <div className="flex items-center justify-between">
                    ...
                    {unreadCount > 0 && (
                      <Badge variant="secondary" className="text-xs bg-primary/10 text-primary border /20">
                        {unreadCount} new
                      </Badge>
                    )}
                  </div>
              ...
              <DropdownMenuContent align="end" className="w-56 p-2">
                <div className="px-3 py-2 -mx-2 -mt-2 bg-muted/30 rounded-t-md mb-2">
                  <div className="flex flex-col">
                    ...
                    <Badge variant="outline" className="mt-2 bg-primary/10 text-primary text-[10px] border /20 w-fit">
                      {user?.plan || 'Free'} Plan
                    </Badge>
                  </div>
                </div>
